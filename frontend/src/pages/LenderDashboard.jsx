    ...
    <div className="page" style={{ position: 'relative', minHeight: '100vh' }}>
      ...
      <div className="container" style={{ padding: '2.5rem 1.5rem' }}>
        ...
        {fetching ? (
          ...
          <div>
            <h2 style={{ fontSize: '15px', fontWeight: 700, color: 'var(--ink)', marginBottom: '1rem' }}>
                ...
                return (
                  <div key={i} className="card card-hover" style={{ padding: '1.5rem' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '1rem' }}>
                      ...
                      {/* ── BUTTONS: View Profile + Chat ── */}
                      <div style={{ display: 'flex', gap: '6px', alignItems: 'center', flexShrink: 0 }}>
                        <button
                          onClick={() => setProfileModal({ name: inv.borrowerName, address: inv.borrowerAddress, purpose: inv.purpose, category: inv.category, amount: inv.loanAmount, interestRate: inv.interestRate })}
                          className="btn btn-out btn-sm">
                          👤 Profile
                        </button>

                        {/* Chat Button — only if borrower address known and different from me */}
                        <ChatButton
                          loanId={inv.loanId}
